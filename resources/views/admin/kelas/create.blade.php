            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                    <label class="block text-sm">
                        ...
                        <select id="tingkat_kelas" name="tingkat_kelas"
                            ...
                            <option value="I" {{ old('tingkat_kelas') == 'I' ? 'selected' : '' }}>- I -</option>
                            <option value="II" {{ old('tingkat_kelas') == 'II' ? 'selected' : '' }}>- II -</option>
                            <option value="III" {{ old('tingkat_kelas') == 'III' ? 'selected' : '' }}>- III -</option>
                            <option value="IV" {{ old('tingkat_kelas') == 'IV' ? 'selected' : '' }}>- IV -</option>
                            <option value="V" {{ old('tingkat_kelas') == 'V' ? 'selected' : '' }}>- V -</option>
                            <option value="VI" {{ old('tingkat_kelas') == 'VI' ? 'selected' : '' }}>- VI -</option>
                            <option value="VII" {{ old('tingkat_kelas') == 'VII' ? 'selected' : '' }}>- VII -</option>
                            <option value="VIII" {{ old('tingkat_kelas') == 'VIII' ? 'selected' : '' }}>- VIII -</option>
                            <option value="IX" {{ old('tingkat_kelas') == 'IX' ? 'selected' : '' }}>- IX -</option>
                ...
                <div>
                    <label class="block text-sm">
                        ...
                        <select id="jurusan" name="jurusan"
                            ...
                            <option value="TIDAK_ADA" {{ old('jurusan') == 'TIDAK_ADA' ? 'selected' : '' }}>- Tidak Ada -
                            </option>
                        </select>
                        <!-- End Select -->
                        @error('jurusan')
                ...
                <div>
                    <label class="block text-sm">
                        ...
                        <select id="urusan_kelas" name="urusan_kelas"
                            ...
                            @for ($i = 1; $i <= 20; $i++)
                                <option value="{{ $i }}" {{ old('urusan_kelas') == $i ? 'selected' : '' }}>-
                                    {{ $i }} -</option>
                            @endfor
                        </select>
                        @error('urusan_kelas')
                ...
                <div>
                    <label class="block text-sm">
                        ...
                        <select id="kelompok" name="kelompok"
                            ...
                            <option value="D" {{ old('kelompok') == 'D' ? 'selected' : '' }}>- D -</option>
                            <option value="E" {{ old('kelompok') == 'E' ? 'selected' : '' }}>- E -</option>
                            <option value="F" {{ old('kelompok') == 'F' ? 'selected' : '' }}>- F -</option>
                            <option value="G" {{ old('kelompok') == 'G' ? 'selected' : '' }}>- G -</option>
                            <option value="H" {{ old('kelompok') == 'H' ? 'selected' : '' }}>- H -</option>
                            <option value="I" {{ old('kelompok') == 'I' ? 'selected' : '' }}>- I -</option>
                            <option value="J" {{ old('kelompok') == 'J' ? 'selected' : '' }}>- J -</option>
                        </select>
                        @error('kelompok')
                            <span class="text-xs text-red-600 dark:text-red-400">{{ $message }}</span>
                        @enderror
                ...
                <div>
                    <label class="block text-sm">
                        ...
                        <input type="text" id="live-input" name="live" value="{{ old('live') }}"
        ...
        $(document).ready(function() {
            $('#live-input').on('input', function() {
                ...
                if (match) {
                    ...
                    youtubePreview.html(`
                <iframe class="w-full min-h-60 rounded" src="https://www.youtube.com/embed/${videoId}"
            ...
            `);
                ...
                <div class="flex flex-auto flex-col justify-center items-center p-4 md:p-5">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-youtube size-10 text-gray-500 dark:text-neutral-500">
